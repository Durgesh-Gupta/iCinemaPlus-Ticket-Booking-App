...
const MovieState = (props) => {
  ...
  const getMovies = async () => {
    const response = await fetch(`/api/movies/allmovies`, {
      method: "GET",
      headers: {
  ...
  const addMovie = async (formData) => {
    ...
    //Api Request
    const response = await fetch(`/api/movies/addmov`, {
      method: "POST",
      headers: {
        // "content-type": "application/json",
  ...
  const deleteMovie = async (id) => {
    //API CAll
    const response = await fetch(`/api/movies/deletemov/${id}`, {
      method: "PUT",
      headers: {
        "content-type": "application/json",
        "auth-token": localStorage.getItem("Authtoken"),
  ...
  const editMovie = async (id, title, description, genre, release_date) => {
    ...
    // );
    //API CALL
    const response = await fetch(`/api/movies/updatemov/${id}`, {
      method: "PUT",
      headers: {
        "auth-token": localStorage.getItem("Authtoken"),
      },
  ...
  const fetchBooking = async (id) => {
    const response = await fetch(`/api/movies/bookingDetails`, {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
  ...
  const TicketBooking = async (showtime, seat_arr) => {
    ...
    for (let index = 0; index < seat_arr.length; index++) {
      //API CAll
      const response = await fetch(`/api/booking/select`, {
        method: "POST",
        headers: {
          "content-type": "application/json",
  ...
  const deleteShow = async (id) => {
    //API CAll
    const response = await fetch(`/api/show/deleteshow/${id}`, {
      method: "PUT",
      headers: {
        "content-type": "application/json",
        "auth-token": localStorage.getItem("Authtoken"),
  ...
  const updateShowTime = async ({ id, time }) => {
    ...
    //API CALL
    const response = await fetch(`/api/show/updateShow/${id}`, {
      method: "PUT",
      headers: {
        "content-type": "application/json",
        "auth-token": localStorage.getItem("Authtoken"),
  ...
  const addShowtime = async ({ movie, theater, time }) => {
    ...
    //Api Request
    const response = await fetch(`/api/show/createShow`, {
      method: "POST",
      headers: {
        "content-type": "application/json",
        // "auth-token": localStorage.getItem("Authtoken"),
